...
def assgin_gate():
    ...
    gates = ['C44', 'C45', 'C46', 'C47',
             ...
             'C66', 'C67', 'C69']
    # dummy = {'Dapte':'10/18/2019', 'rows':[{'Arrival':'Bogota', 'Schedule_Depart_Time':'5:25','flight_number':'a1'},
    #                                       {'Arrival':'Bogota', 'Schedule_Depart_Time':'5:20','flight_number':'a2'},
    #                                       {'Arrival':'Bogota', 'Schedule_Depart_Time':'5:10','flight_number':'a3'},
    #                                       {'Arrival':'Bogota', 'Schedule_Depart_Time':'6:30','flight_number':'a4'}]}
    dummy = content
    ...
    for row in dummy['rows']:
        ...
        for i in range(len(date_helper)-1, -1, -1):
            if date_diff(date_helper[i], row['Schedule_Depart_Time'])<=30:
        ...
        for i in range(0,5):
            ...
            tmp_dict['shopTime'] = gate_pred[i][1]
        ...
        res['map'][pre[0]].append({'flight number':row['flight_number'], 'dest':row['Arrival'], 'ScheduledDT':row['Schedule_Depart_Time']})
...
def predict():
    ...
    gates = ['C44', 'C45', 'C46', 'C47',
             ...
             'C60', 'C61', 'C62', 'C63', 'C64', 'C65',
             'C66', 'C67', 'C69']
    dummy = ['Bogota', '10/18/2019', 6.5, '6:20']
...
'''
['Date', 'Schedule_Depart_Time', 'Flying_Hours', 'year', 'weekofyear',
